<?php
	...
	if(!isset($_SESSION['sebagai'],$_SESSION['nama'],$_SESSION['pass'])){
		...
		$status = $_POST['status'];
		$ket = $_POST['ket'];
		$insert = mysql_query("INSERT INTO guru(id_guru,nm_guru,password,alamat,jk,agama,tempat_lahir,tgl_lahir,status,keterangan) values('$id','$nama','$pass','$alamat','$jk','$agama','$tempat_lahir','$thn''$bln''$tgl','$status','$ket')");
		if($insert){
