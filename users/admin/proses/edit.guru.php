<?php
	...
	if(!isset($_SESSION['sebagai'],$_SESSION['nama'],$_SESSION['pass'])){
		...
		$status = $_POST['status'];
		$ket = $_POST['ket'];
		$edit = mysql_query("UPDATE guru SET nm_guru='$nama',password='$pass',agama='$agama',alamat='$alamat',jk='$jk',tempat_lahir='$tempat_lahir',tgl_lahir='$thn''$bln''$tgl',status='$status',keterangan='$ket' WHERE id_guru='$id'");
		if($edit){
